				 	...
				 	<td colspan="2" rowspan="5">
				 		<xsl:element name="img">
			              	<xsl:attribute name="src">
								C:\Users\Lenovo\Desktop\XML\Projekat\XML-project\backend\ZigBackend\src\main\resources\uploadedFiles\<xsl:value-of select="//sz:Zig//sz:Izgled_putanja_do_slike"/>
			              	</xsl:attribute>
			            </xsl:element>
				 	</td>
			      </tr>
				...
				<table>			
				  <tr>
				  	...
				  	<td rowspan="7" style="text-align: center; border-top-width:1px;">Broj prijave ziga: <br/>
				  		...
				  		Datum podnosenja: <br/>
<!--				  		<xsl:value-of select="format-dateTime(//sz:Datum_podnosenja, '[M01].[D01].[Y0001].')"/>-->
						<xsl:value-of select="//sz:Datum_podnosenja"/>
					</td>
				  </tr>
					<tr>
				    ...
				    <tr>
						...
						<xsl:choose>
					 		...
					 		<xsl:when test="//sz:Prilog_punomocje//sz:Status_priloga='BICE_NAKNADNO_PREDATO'">
					 			<td>BICE NAKNADNO PREDATO</td>
					 		</xsl:when>
					 		<xsl:when test="//sz:Prilog_punomocje//sz:Status_priloga='NIJE_PREDATO'">
					 			<td>NIJE PREDATO</td>
					 		</xsl:when>
					 		<xsl:when test="//sz:Prilog_punomocje//sz:Status_priloga='NIJE_POTREBNO'">
					 			<td>NIJE POTREBNO</td>
					 		</xsl:when>
					 		<xsl:otherwise>
				...
				<center>
					<xsl:element name="img">
						<xsl:attribute name="src">
							C:\Users\Lenovo\Desktop\XML\Projekat\XML-project\backend\ZigBackend\src\main\resources\generatedFiles\QR\<xsl:value-of select="//sz:Prilog//sz:Tip_priloga[text()='QR']//..//sz:Putanja_do_priloga"/>
						</xsl:attribute>
					</xsl:element>
				</center>
            </body>
